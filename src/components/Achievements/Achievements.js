...
function Achievements() {
    return (
        <Container className="achievements mt-5 px-5 pb-5">
            <Row className="achievements__row px-5 pb-5">
                <Col lg={7} className="achievements__col mt-5 pb-5">
            ...
            <Row className="achievements--row px-5 pb-5">
                <Col lg={3} className="achievements__col pb-5">
                    <Card style={{width: '15rem'}}>
                        <Card.Img variant="top" src={Icon1} className="achievements__icon achievement__icon--first"/>
                        <Card.Body>
                ...
                <Col lg={3} className="achievements__col">
                    <Card style={{width: '15rem'}}>
                        <Card.Img variant="top" src={Icon2} className="achievements__icon achievement__icon--second" />
                        <Card.Body>
                ...
                <Col lg={3} className="achievements__col">
                    <Card style={{width: '15rem'}}>
                        <Card.Img variant="top" src={Icon3} className="achievements__icon achievements__icon--three" />
                        <Card.Body>
                ...
                <Col lg={3} className="achievements__col">
                    <Card style={{width: '15rem'}}>
                        <Card.Img variant="top" src={Icon4} className="achievements__icon achievements__icon--five"/>
                        <Card.Body>
