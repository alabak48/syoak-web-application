            ...
            <FadeInEffect>
                <Carousel ref={ref} variant="dark" indicators={false} controls={false}
                    ...
                    <Carousel.Item className="pt-5 px-lg-5 px-md-0 px-sm-5" interval={1500}>
                        ...
                        <Container>
                            <Row className="pt-5 pt-lg-0 px-lg-5 px-sm-5 carousel__row">
                                <Col xxl={4} xl={4} lg={4} md={6} sm={12} className="carousel__text">
                                ...
                                <Col xxl={8} xl={8} lg={8} md={6} className="carousel-wrapper__img d-flex align-items-end justify-content-center">
                    ...
                    <Carousel.Item className="pt-5 px-lg-5 px-md-0 px-sm-5" interval={2100}>
                        ...
                        <Container>
                            <Row className="pt-5 px-lg-5 px-sm-5 carousel__row">
                                ...
                                <Col xxl={8} xl={8} lg={8} md={6} className="carousel-wrapper__img d-flex justify-content-center align-items-end">
                                    <div className="wrapper__tooltip--first">
                                        <div className="tooltip__img">
                                            <img src={Drop} alt="Gas Drop" />
                                        </div>
                    ...
                    <Container>
                        ...
                        <Container>
                            <Row className="pt-5 px-lg-5 px-sm-5 carousel__row">
                                <Col xxl={4} xl={4} lg={4} md={6} sm={12} className="carousel__text pb-5 pb-sm-5">
