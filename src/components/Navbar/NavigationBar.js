                ...
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav className="registration">
                            <Nav.Link className="registration registration__log-in"><FaUserCircle className="icon-registration icon-registration__log-in" /> Log in</Nav.Link>
                            <Nav.Link eventKey={2} className="registration registration__contact-us">
                                <FaPaperPlane className="icon-registration icon-registration__contact-us" /> Contact us
                            </Nav.Link>
